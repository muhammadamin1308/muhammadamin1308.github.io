...
const About = () => {
  return (
    <section
      data-section
      id="about"
      className="shadow bg-black w-screen min-h-screen flex items-center"
    >
      <div className="max-w-6xl w-full mx-auto px-6 md:px-12 py-20">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-center justify-center md:justify-between gap-12">
          ...
          <div className="md:w-2/3 text-center md:text-start flex flex-col justify-center items-center md:items-start">
            ...
            <p className="mt-6 text-base md:text-lg text-slate-300 max-w-3xl">
              Self-taught Full-Stack Developer from Uzbekistan, specializing in
              modern web technologies and open-source development. Passionate
              about building scalable applications with React.
            </p>
          </div>
        </div>
      </div>
